...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	УстановитьЗначениеПараметровСписка(Список, Конфигурация, ОтборСостоянияЗадач);
...
Процедура ПриОткрытии(Отказ)
	...
	ПодключитьОбработчикОжидания("УстановитьЗначениеПараметровСпискаНаКлиенте", 3600, Ложь);
...
&НаКлиенте
Процедура УстановитьЗначениеПараметровСпискаНаКлиенте() Экспорт
...
Процедура УстановитьЗначениеПараметровСписка(Список, Конфигурация, ОтборСостоянияЗадач)
...
Процедура ОбновитьЗначенияДиаграммыСрокиЗадач()
	...
	ЦветНовых 		= Новый Цвет(218, 106, 0);
	ЦветЗакрытых 	= Новый Цвет(20, 71, 30);
...
Функция ДанныеПоСрокамЗадач(Конфигурация)
	...
	Запрос.Текст = 
		...
		|	ГДЕ
		|		Задачи.ДатаСоздания >= &ДатаСбораСтатистики
		|		И Задачи.ДатаЗавершения <> ДАТАВРЕМЯ(1, 1, 1)
		|		И Задачи.Конфигурация = &Конфигурация
		|		И Задачи.Состояние <> Значение(Перечисление.СостоянияЗадач.Отменено)
		|	СГРУППИРОВАТЬ ПО
