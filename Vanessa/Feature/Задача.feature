...
Сценарий: Проверка функционала формы элемента задачи
	...
	* Тестирование выбора типа задачи

		И из выпадающего списка с именем "ТипЗадачи" я выбираю по строке 'Метод расположен не в своей области'
		Тогда элемент формы с именем "Описание" стал равен 'Метод расположен не в своей области'

		И в поле с именем 'ТипЗадачи' я ввожу текст ''
		И в поле с именем 'Описание' я ввожу текст 'Альтернативный текст'

		И из выпадающего списка с именем "ТипЗадачи" я выбираю по строке 'Метод расположен не в своей области'
		Тогда элемент формы с именем "Описание" стал равен 'Альтернативный текст'	

		И в поле с именем 'ТипЗадачи' я ввожу текст ''
		И в поле с именем 'Описание' я ввожу текст ''
		И в поле с именем 'Наименование' я ввожу текст ''
		И из выпадающего списка с именем "ТипЗадачи" я выбираю по строке 'Метод расположен не в своей области'
		Тогда элемент формы с именем "Наименование" стал равен 'Метод расположен не в своей области'
		Тогда элемент формы с именем "Описание" стал равен 'Метод расположен не в своей области'				
	...
	* Копирование задачи
		...
		И элемент формы с именем "Наименование" стал равен 'Метод расположен не в своей области'
		И элемент формы с именем "ДатаЗавершения" стал равен '  .  .       :  :  '
		И Я запоминаю значение выражения 'Лев(ТекущаяДата(), 10) + "*"' в переменную "ТекущаяДатаСеанса"	
		И элемент формы с именем "ДатаСоздания" стал равен '$ТекущаяДатаСеанса$' по шаблону
		И Я закрываю окно 'Задача (создание)'
