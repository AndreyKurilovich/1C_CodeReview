...
Функция ДанныеКачестваВыполненияЗадач(Конфигурация)
	...
	Запрос.УстановитьПараметр("Конфигурация", Конфигурация);
	Запрос.УстановитьПараметр("ДатаСбораСтатистики", ДатаСбораСтатистикиДиаграм());
...
Процедура ОбновитьЗначенияДиаграммыСрокиЗадач()
	...
	Для каждого СтатистикаЗаНеделю Из ДанныеПоСрокамЗадач Цикл
		...
		СерияНовых.Цвет = WebЦвета.Лосось;
		...
		СерияЗакрытых.Цвет = WebЦвета.ЗеленыйЛес;
...
&НаСервере
Функция ДатаСбораСтатистикиДиаграм()
